...
// Frontend URL for Stripe redirects (replace with your actual frontend URL)
const FRONTEND_URL = 'https://thrive-x.com';
...
router.post('/create-checkout-session', async (req, res) => {
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'subscription',
      success_url: `${req.headers.origin || FRONTEND_URL}/fitness/subscribe?success=true`,
      cancel_url: `${req.headers.origin || FRONTEND_URL}/fitness/subscribe?canceled=true`
    });
